...
class ShowCartList extends StatefulWidget {
  ...
  ShowCartList({this.index, this.list , this.number});

  @override
  ShowCartListState createState() => ShowCartListState();
}

class ShowCartListState extends State<ShowCartList> {
            ...
            IconButton(
              ...
              onPressed: ()=> Navigator.of(context).push(
                  new MaterialPageRoute(
                    builder: (BuildContext context) => widget.number == 1 ?  new CartList() ?? widget.number == 2 : new Dashboard(),
                  )
              ),
            )
          ],
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: new FlatButton(
                      onPressed: () {
                        databaseHelper.deleteCartList(widget.list[widget.index]['id']);
