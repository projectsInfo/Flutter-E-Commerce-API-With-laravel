...
class EditData extends StatefulWidget {
  ...
  EditData({this.index, this.list , this.number});
...
@override
  ...
  super.initState();
    ...
    _detailsController = new TextEditingController(text:   widget.list[widget.index]['details']);

    fileName =    widget.list[widget.index]['image'];
    base64 =    widget.list[widget.index]['tmp_name'];
